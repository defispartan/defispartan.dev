...
const ButtonRow = () => {
    ...
    return (
        <div className={styles.iconRow}>
            ...
            >
                <Image src='/github.svg' alt='GitHub' width={32} height={32} className={styles.iconButtonImage} />
            </button>
            ...
            >
                <Image src='/twitter.svg' alt='Twitter' width={32} height={32} className={styles.iconButtonImage} />
            </button>
            ...
            >
                <Image src='/lens.svg' alt='Lens' width={32} height={32} className={styles.iconButtonImage} />
            </button>
            ...
            >
                <Image src='/youtube.svg' alt='YouTube' width={32} height={32} className={styles.iconButtonImage} />
            </button>
            ...
            >
                <Image src='/email.svg' alt='Email' width={32} height={32} className={styles.iconButtonImage} />
            </button>
        </div>
    );
};
